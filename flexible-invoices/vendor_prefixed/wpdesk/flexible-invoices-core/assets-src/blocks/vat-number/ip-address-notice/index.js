 ...
 */
export const IpAddressNotice = ( { shouldValidateIp, billingCountry, ipAddress, ipCountry, validation, checkoutExtensionData, } ) => {
	...
	const isSelfDeclarationRequired = shouldValidateIp && billingCountry !== ipCountry;
	useEffect( () => {
