...
final class Tracker
{
    ...
    private function register_hooks()
    {
        ...
        add_action('admin_init', [\WPDeskFIVendor\WPDesk_Tracker::class, 'schedule']);
    ...
    public function send_scheduled_tracking_data()
    {
        ...
        if ($tracker instanceof \WPDeskFIVendor\WPDesk_Tracker) {
    ...
    private function get_tracker()
    {
        ...
        if (!is_object($tracker)) {
            $factory = new \WPDeskFIVendor\WPDesk_Tracker_Factory_Prefixed($this->logger);
