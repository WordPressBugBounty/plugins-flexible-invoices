...
Test Flexible PDF Invoices for WooCommerce & WordPress (free, PRO, and add-ons) in **[your free demo](https://wpdesk.link/demo-fi)**.
...
= 6.2.27 - 2026-08-19 =
* Another fix related to foul plugin library error.

= 6.2.26 - 2026-08-18 =
* Fix fatal error on plugin initialization.
...
= 6.2.20 - 2026-06-01 =
* Fixed problem with loading customer vat number into block checkout

= 6.2.19 - 2026-05-29 =
* Fixed problem with downloading invoices on PHP < 8
...
= 6.2.11 - 2026-03-12 =
* Fixed problem with KSeF QR codes on invoices
...
= 6.0.13 - 2025-09-15 =
* Added document duplication guard (enable by filter)
* Added prominent notice about invoice duplication
...
= 6.0.9 - 2025-08-19 =
* Fixed notice on appearance page

= 6.0.9 - 2025-08-07 =
* Added support for WooCommerce 10.1

= 6.0.8 - 2025-07-30 =
* Added currency symbol in "Discount" column while using block templates

= 6.0.7 - 2025-07-23 =
* Removed empty space after prefix for gutenberg document templates

= 6.0.6 - 2025-07-17 =
* Added support for WooCommerce 10.0

= 6.0.5 - 2025-05-15 =
* Added rewrite rules flushing fixing problem with 404 on invoice template preview
* Added 'none' as option to select invoice numbering reset for block templates
...
= 6.0.1 - 2025-04-16 =
* Resolved issue with updating VAT number for future subscriptions (WooCommerce Subscriptions) from /my-account/ page
